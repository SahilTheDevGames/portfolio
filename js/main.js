...
function loadVideo(videoID) {
   // var videoID = 'FVrF3efVAVM'; // Replace with your actual YouTube video ID
...
function resetVideo() {
    var iframe = document.getElementById('video-iframe');
    iframe.src = '';  // Reset the video source to stop the video
    iframe.style.display = 'none';  // Hide the iframe
    document.querySelector('.video-thumbnail').style.display = 'block';  // Show the thumbnail again
}
